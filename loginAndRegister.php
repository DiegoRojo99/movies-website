<?php 
	...
	if(isset($_POST['Email'])){
		...
		$dataBase = connectDB();
		$q1='INSERT INTO User VALUES("';
		$q2='","';
		$q3='");';
		$query=$q1.$username.$q2.$email.$q2.$password.$q3;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12">
					...
					<?php
						if($reg){
							echo '<h2 class="section__title">Thanks for registering</h2>';
						}else if($log){
							echo '<h2 class="section__title">Welcome back '.$_POST['Username'].'</h2>';
						}else{
							echo 'Are you lost?';
						}
					?>
